...
<a href="/" class="navbar-brand"><img src="img/logo.png" alt="Newe - Game Theme HTML"></a>
<nav class="nav">
<ul>
...
<li class="hidden-xs-down"><a href="{{ route('register') }}	">Register</a></li> -->
                        ...
                        @if (Auth::guest())
                            <li class="hidden-xs-down"><a href="{{ route('login') }}">Нэвтрэх</a></li>
                            <li class="hidden-xs-down"><a href="{{ route('register') }}">Бүртгүүлэх</a></li>
                        @else
